...
// tag: node label (cf EnunTag)

public class Stree {

    protected EnunTag tag;	// node label
    ...
    public Stree(EnunTag tag, Stree left, Stree right, Object object) {
        this.tag=tag;
        this.left=left;
        this.right=right;
        this.object=object;
    ...
    public void setLeft(Stree l){
        this.left = l;
    }

    public void setRight(Stree r){
        this.right = r;
    }
    ...
    public String toString() {
        ...
        if ((left != null) || (right != null)){
            ...
            if (right != null){
                result+=",";
                if (right.tag==EnunTag.SUCC || right.tag==EnunTag.THENELSE)
                    result+="\n\n\t";
